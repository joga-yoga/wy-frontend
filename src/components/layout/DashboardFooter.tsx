...
export const DashboardFooter: React.FC<DashboardFooterProps> = ({
  ...
  return (
    <div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-10 h-[64px] md:h-[64px] bg-background border-t flex flex-row justify-between items-center gap-0 md:gap-4 px-3 md:px-6 md:left-[0px] md:z-20">
        <div>
