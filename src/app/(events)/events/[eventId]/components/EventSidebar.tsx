...
export const EventSidebar: React.FC<EventSidebarProps> = ({ event }) => {
  return (
    <div className="lg:col-span-1 flex flex-col gap-[44px]">
      <div className="space-y-2 border border-gray-100 rounded-[22px] shadow-[0px_8px_16px_8px_#FAFAFA] p-5">
        <div className="border border-gray-100 rounded-t-[20px] rounded-b-[4px]">
          <div className="px-5 py-8">
            <div className="flex justify-between items-center">
              <div>
                <p className="text-descr-under-big-head font-medium">
                  {formatDateRange(event.start_date, event.end_date)}
                </p>
                <a
                  href="#cancellation-policy"
                  className="text-sub-descript-18 text-gray-500 underline"
                >
                  Bezpłatna anulacja
                </a>
              </div>
          ...
          <div className="p-5">
            <div className="space-y-4">
              <a href="#map" className="flex items-center gap-3">
                <div className="h-12 w-12 border-2 border-gray-500 rounded-md flex items-center justify-center overflow-hidden">
                  <Image src="/images/map.png" alt="Map icon" width={48} height={48} />
                </div>
                <p className="text-sub-descript-18">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-subheader">Cena</p>
              ...
              {event.skill_level && event.skill_level.length > 0 && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-subheader">Poziom Yogi</p>
                    <p className="text-sub-descript-18 text-gray-500">
                      {event.skill_level
              ...
              {event.language && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-subheader">Język wydarzenia</p>
                    <p className="text-sub-descript-18 text-gray-500">
        ...
        {event.main_attractions && event.main_attractions.length > 0 && (
          <div className="p-5 border border-neutral-100 rounded-[22px]">
            <h3 className="text-center text-subheader mb-3">Najważniejsze atrakcje</h3>
            <ul className="list-disc pl-5 space-y-1 text-sub-descript-18 text-gray-500">
      ...
      {event.instructors && event.instructors.length > 0 && (
        <div className="space-y-8">
          <h2 className="text-h-middle text-gray-800">Instruktor</h2>
      ...
      {event.cancellation_policy && (
        ...
        >
          <h3 className="text-subheader text-gray-800">Zasady anulowania rezerwacji</h3>
          <p className="text-sub-descript-18 text-gray-500 text-left">
            {event.cancellation_policy}
          </p>
        </div>
      )}
