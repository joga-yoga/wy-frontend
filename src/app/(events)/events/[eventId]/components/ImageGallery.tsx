...
export const ImageGallery: React.FC<ImageGalleryProps> = ({ image_ids, title }) => {
  ...
  return (
    <Dialog open={isFullScreen} onOpenChange={setIsFullScreen}>
      ...
      <DialogContent
        className="h-full md:h-[calc(100dvh-40px)] w-full max-w-full md:max-w-[calc(100dvw-40px)] rounded-none md:rounded-lg overflow-y-scroll p-4 pb-10"
        onOpenAutoFocus={(e) => e.preventDefault()}
      >
        <DialogTitle className="pb-0">Zdjęcia</DialogTitle>
