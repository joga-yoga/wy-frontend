...
export function ScheduleBlock() {
      ...
      <section>
        <div className="flex items-center gap-2 px-1 py-2 text-xs text-gray-400">
          ...
          <span>
            ...
            <Link href="/konto/partner/studio/create" className="text-blue-600 hover:underline">
              Dodaj studio
            </Link>
  ...
  if (data.mode === "owner") {
    ...
    return (
      <section className="space-y-2">
        ...
        <Link href="/konto/partner/grafik" className="block">
        ...
        {data.studio_ids[0] && (
          <Link href={`/konto/partner/studio/${data.studio_ids[0]}/front-desk`} className="block">
            <Button variant="outline" className="w-full text-sm">
  ...
  return (
    <section className="space-y-2">
      ...
      <Link href="/konto/partner/grafik/instructor" className="block">
        <Button variant="outline" className="w-full text-sm">
          <Calendar size={14} className="mr-2" />
          Zobacz mój grafik
        </Button>
