...
interface EventPricingSectionProps {
  ...
  includeLists?: boolean; // price_includes, price_excludes, paid_attractions
}
    ...
    <>
      <div className="space-y-2 event-form-section-padding" id="event-pricing-section">
        ...
        <Label htmlFor="price" size="event-description">
          Podaj pełną cenę za udział za jedną osobę
        </Label>
      ...
      {includeLists && (
        <div className="space-y-2 event-form-section-padding">
          ...
          <Label htmlFor="paid_attractions" size="event-description">
            Podziel się informacjami o innych aktywnościach, które uczestnicy mogą zrobić w okolicy
            za dodatkową opłatę
          </Label>
          <Separator className="my-4 md:my-8" />
          <Controller
      ...
      <div className="space-y-2 event-form-section-padding">
        ...
        <Label htmlFor="cancellation_policy" size="event-description">
          Tutaj należy opisać, na jakich warunkach uczestnik może odwołać swój udział
        </Label>
        <Separator className="my-4 md:my-8" />
        <Textarea
