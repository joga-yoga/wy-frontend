  ...
  return (
    <div className="space-y-2 event-form-section-padding" id="event-policies">
      ...
      <Label htmlFor="important_info" size="event-description">
        Podziel się dodatkowymi informacjami, które mogą być istotne dla uczestników. Ta sekcja nie
        będzie publikowana w ofercie, a jedynie widoczna w powiadomieniach e-mail dla klientów
      </Label>
