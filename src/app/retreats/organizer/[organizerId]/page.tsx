...
import { EventSection, ReviewSection } from "@/app/retreats/organizer/[organizerId]/components";
import { reviews } from "@/app/retreats/organizer/[organizerId]/data";
import { OrganizerDetails } from "@/app/retreats/organizer/[organizerId]/types";
        ...
        <div className="flex flex-col gap-[44px]">
          ...
          <div className="flex flex-col gap-[44px]">
            ...
            {organizer.upcoming_events.length > 0 && (
              <EventSection title="Planowane wyjazdy" events={organizer.upcoming_events} />
            )}
            {organizer.past_events.length > 0 && (
              <EventSection title="Zakończone wyjazdy" events={organizer.past_events} />
            )}
          </div>
        </div>
      </div>
