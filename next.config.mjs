...
const nextConfig = {
  ...
  async rewrites() {
    return [
      ...
      { source: "/konto/partner/wiadomosci", destination: "/account/partner/messages" },
      { source: "/konto/partner/wiadomosci/:path*", destination: "/account/partner/messages/:path*" },
      { source: "/konto/partner/zamowienia", destination: "/account/partner/orders" },
      { source: "/konto/partner/zamowienia/:path*", destination: "/account/partner/orders/:path*" },
  ...
  async redirects() {
    ...
    return [
      ...
      { source: "/profile/messages", destination: "/konto/partner/wiadomosci", permanent: false },
      { source: "/profile/messages/:path*", destination: "/konto/partner/wiadomosci/:path*", permanent: false },
      { source: "/profile/orders", destination: "/konto/partner/zamowienia", permanent: false },
      { source: "/profile/orders/:path*", destination: "/konto/partner/zamowienia/:path*", permanent: false },
